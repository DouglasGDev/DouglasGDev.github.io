...
$(function(){
    ...
    // **************** Substituir a api key abaixo para rodar o projeto *****************

    var accuweatherAPIKey = "YJxFEYKbB8mAEuIsJOAwoIMMMgyuT3Xq";
    var mapboxToken ="pk.eyJ1IjoiZG91Z2xhc2dyb2ZmIiwiYSI6ImNsNG9ldXNsNzA2dWgzZHF1MDh1M2J0eW0ifQ.j2XA5LxTTOlBrgZ1N6FT6g";
   ...
   // ************************************************************************************************
    ...
    function pegarCoordenadasDaPesquisa(input) {
        ...
        $.ajax({
            //"https://api.mapbox.com/geocoding/v5/mapbox.places/Los%20Angeles.json?access_token=pk.eyJ1IjoiZG91Z2xhc2dyb2ZmIiwiYSI6ImNsNG9lcGJrNzAwNXMzb3BoM3ozM2M0NGYifQ.vaVAeS7qnlmZvfOQxhrdrQ"
